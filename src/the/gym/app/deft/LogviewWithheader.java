...
public class LogviewWithheader extends Activity implements OnTouchListener{
...
//		ListView SelectList;
	...
	oneValue = new String[1];
		...
		customDialogClass = new CustomDialogClass(LogviewWithheader.this);
	  	               
		
		_Id = getIntent().getStringExtra("idval");
		...
		LogviewWithheader.this.loader.
		
		init(ImageLoaderConfiguration.createDefault(LogviewWithheader.this));
		...
		if(ConditionClas.isNetworkAvailable(LogviewWithheader.this))
		{
		...
		new SomeView_Async().execute("");
			...
			ConditionClas.Toastmethod(LogviewWithheader.this   , 
...
//			SelectList =(ListView)findViewById(R.id.shedulelist);
			...
			myList = (ListView) findViewById(R.id.shedulelist);
...
//	        View header = findViewById(R.layout.header);
	        
	        System.out.println("header     " +Header);
	        System.out.println("header     " +myList);
...
//				Direction.setBackgroundResource(R.drawable.b);
		...
		backButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(LogviewWithheader.this , HomeScreen.class);
		...
		Submit.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
			  ...
			  if (f==true) {
				  ...
				  ConditionClas.Toastmethod(LogviewWithheader.this,"Do not leave any field empty");
	...
	private void AllOnItemClickListener() {
		...
		VideoList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent = new Intent(LogviewWithheader.this ,
						PlayVideo.class);
...
//						}
		...
		protected void onPreExecute() {
			...
			dialog = new ProgressDialog(LogviewWithheader.this);
		...
		protected void onPostExecute(String result) {
			...
			if(done_is==true)
			{
				...
				ConditionClas.Toastmethod(LogviewWithheader.this, " " +MessageDisplay_Submit);
			...
			if(Methodcall.equalsIgnoreCase("submit"))
			{
				...
				ConditionClas.Toastmethod(LogviewWithheader.this, " " +MessageDisplay);
...
//							contains(method(exc_Name).toLowerCase()))
							...
							contains(_Id.toLowerCase()))
					{
						...
						Log_Nots.add(SiteList.Log_Nots.get(i)) ;
				...
				System.out.println("inside show Log_Nots " +Log_Nots);
...
//					VideoList.setAdapter()
			 ...
			 *  so on basis of that it shall set an adapter */
					...
					if(MesageList.length()>0)
				{
						...
						myList.setAdapter(new CustomList());
//						updateTable();
						...
						myList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
							...
							public void onItemClick(AdapterView<?> arg0,
								...
								if(arg2>0)
								{
								showAlert(Log_Nots.get(arg2-1));
								}
								else {
									showAlert(Log_Nots.get(arg2));
								}
	...
	class CustomList extends BaseAdapter{
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			LayoutInflater inflater = (LayoutInflater)
					LogviewWithheader.this.getSystemService(Activity.
			...
			if(arg1 == null)
			{
				...
				arg1 = inflater.inflate(R.layout.logview_listobject, null);
				...
				holder.Sets      = (TextView)arg1.findViewById(R.id.sets);
				
				holder.Intensity    = (TextView)arg1.findViewById(R.id.intensity);
				arg1.setTag(holder);
			}
			...
			holder.Repetition.setText("Reps: "+Log_Sets.get(arg0));
		
			holder.Sets.setText("Weight:   "+Log_reps.get(arg0));
